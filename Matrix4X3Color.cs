...
/// <summary>
///     A 4x3 matrix / 3x4 matrix comprised of 12 floats. + 4 Custom Data floats.
...
public struct Matrix4X3Custom
{
    ...
    /// </summary>
    public Matrix4X3Custom(Vector3 translation, float uniformScale = 1)
    {
        M00 = uniformScale;
        M01 = 0;
        M02 = 0;
